...
{   
    ...
    if(isset($_POST['create']))
    {
        ...
        $destino = "categorias/" . $portada;
        move_uploaded_file($portada_temp, $destino);

        $sql = "INSERT INTO tblcategory(CategoryName, Description, colocación, Status, Image) VALUES(:CategoryName, :Description, :colocacion, :status, :Image)";
