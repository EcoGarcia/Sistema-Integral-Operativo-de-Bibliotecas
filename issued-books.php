...
//     $welcomeMessage = "¡Bienvenido, " . $_SESSION['login'] . "!";
// } else {
            ...
            <div class="col-md-12">
                ...
                <div class="category-container">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='h.php?categoria=" . urlencode($row['CategoryName']) . "' class='btn btn-primary btn-view-books' data-category='" . $row['CategoryName'] . "'>Ver libros</a>";
